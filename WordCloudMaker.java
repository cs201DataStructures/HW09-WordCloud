 ...
 * Modified by Anna Rafferty,2020
 */
public class WordCloudMaker {
    ...
    public static String getWordCloudHTML(String title, List<WordCount> wordCountList) {
        ...
        String document = HTML_TEMPLATE.replaceAll("TITLE", Matcher.quoteReplacement(title));
        document = document.replace("WORDS", wordsInHTML);
